...
如果您的系统遇到了以上问题，建议将 EasyConnect 安装在虚拟机环境或是使用 Docker 容器（操作难度较高，适合专业人士）封装该应用。参见由重庆大学 @Hagb 开源的[docker-easyconnect](https://github.com/Hagb/docker-easyconnect)项目
